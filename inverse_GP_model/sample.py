## Directly copied from the SALib package and only the "skip_values" parameter is altered. 
...
def sample(problem, N, calc_second_order=True):
    ...
    # I have selected this value to be larger than the value used in the n=5000
